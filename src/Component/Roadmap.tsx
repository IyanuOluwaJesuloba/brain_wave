...
const Roadmap = () => {
  return (
    <Section className='overflow-auto' id='roadmap'>
        ...
        <Heading tag='Ready to get started' title='What were working on'/>
            <div className='relative grid gap-6 md:grid-cols-2 md:gap-4 md:pb-[7rem]'>
                {roadmap.map((item)=>{
                    ...
                    return (
                        <div key={item.id} className={`md:flex even:md:translate-y-[7rem] p-0.25 rounded-[2.5rem] ${item.colourful ? 'bg-conic-gradient' : 'bg-n-6'}`}>
                            <div className='relative p-8 bg-n-8 rounded-[2rem] overflow-hidden  xl:p-15 '>
                                ...
                                <div className='relative z-1'>
                                    <div className='flex items-center justify-between max-w-[27rem] mb-8 md:mb-20' >
                                        ...
                                        <div className='flex items-center px-4 py-1 bg-n-1 text-n-8 rounded'>
